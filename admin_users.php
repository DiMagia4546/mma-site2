    ...
    <div class="mt-10 bg-neutral-800 border border-neutral-700 rounded-xl p-8">
        ...
        <table class="w-full text-left">
            ...
            <tr class="border-b border-neutral-700">
                ...
                <td>
                    <a href="edit_user.php?id=<?= $u['id'] ?>" class="text-yellow-400 hover:text-yellow-300">Editar</a> |
                    <a href="delete_user.php?id=<?= $u['id'] ?>" class="text-red-500 hover:text-red-400">Eliminar</a>
                </td>
            </tr>
            <?php endwhile; ?>
